    ...
    <section class="contact-section section_padding">
      <div class="container">
        ...
        <div class="row credientials pt-5">
          <div class="col-lg-5">
            <h2 class="contact-title">Sign up With your Credientials</h2>
          </div>
          <div class="col-lg-7">
            <div class="col-lg-12">
                ...
                <div class="row credientials">
                  ...
                  <div class="col-lg-8">
                    <div class="form-group">
                      <input required class="form-control" name="username" id="username" type="text" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter your Name'" placeholder='Enter your Name' required>
                    </div>
                  </div>

                  <div class="col-lg-8">
                    <div class="form-group">
                      <input required class="form-control" name="email" id="email" type="email" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter email address'" placeholder='Enter email address' required>
                    </div>
                  </div>

                  <div class="col-lg-8">
                    <div class="form-group">
                      <input required class="form-control" name="mobile" id="mobile" type="text" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter Phone Number'" placeholder='Enter Phone Number' required>
                    </div>
                  </div>

                  <div class="col-lg-8">
                    <div class="form-group">
                      <input required class="form-control" name="password" id="password" type="password" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter Password'" placeholder='Enter Password' required>
                    </div>
                  </div>

                  <div class="col-lg-8">
                    <div class="form-group">
                      <input required class="form-control" name="cpassword" id="cpassword" type="password" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Confirm Password'" placeholder='Confirm Password' required>
                    </div>
                  </div>

                  <div class="col-lg-8">
                    <button type="submit" name="submit" class="button-contactForm btn_1">SignUp </button>
                  </div>
                  <div class="col-lg-8 credientials">
                    <h5>
                      Already Have a account. No Problem <a href="login.php"> Login </a> Now
                    </h5>
                  </div>
                  <div class="col-lg-8 credientials">
                    <h5>
